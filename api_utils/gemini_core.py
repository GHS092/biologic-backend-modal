...
async def run_clinical_analysis(
    ...
    try:
        ...
        prompt_text = (
            "Eres un Médico Adscrito (Attending Physician) altamente experimentado y un Motor de Razonamiento Clínico Estructurado.\n"
        ...
        if is_debate_mode:
            ...
            try:
                ...
                debate_prompt = (
                    "Eres el 'Red Team Médico' (Junta Médica Antagonista y Escéptica).\n"
