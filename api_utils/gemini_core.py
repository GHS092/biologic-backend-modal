        ...
        if is_debate_mode:
            ...
            try:
                ...
                debate_prompt = (
                    ...
                    "6. Sub-regla de Falsación Científica y Anclaje (Anti-Sesgo): Audita si el adscrito asumió un diagnóstico tumoral/grave por mera frecuencia o ubicación (sesgo de anclaje) ignorando la falta de prerrequisitos físicos (ej: diagnosticar Schwannoma o tumor maligno en una lesión puramente líquida que tiene 0.0% de realce de contraste y señal idéntica al LCR). Si detectas esta contradicción física, VETA de inmediato el diagnóstico y reordena los diferenciales para colocar la variante benigna, quística perineural o dural ectasia al tope absoluto.\n"
                    "7. Sub-regla de Coherencia de Multiplicidad y Parsimonia (Ockham): Critica si el adscrito diagnosticó múltiples neoplasias independientes raras en un paciente asintomático, en lugar de unificar todo bajo una única variante anatómica benigna común y sistémica (como quistes perineurales o aracnoideos múltiples).\n\n"
